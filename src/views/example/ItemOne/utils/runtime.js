...
function e(e, t, n) {
  ...
  var i = r.defaultView.CustomEvent
  typeof i === 'function'
    ? (i = new i(t, { detail: n }))
...
function m(e) {
  try {
    const t = h.filter(({ symbol: t }) => !0 === e[t])
    if (!t.length) return
    const n = t.find(e => !e.modifier)
    const r = n.name === 'Map' && t.find(e => e.modifier && e.prefix)
    const i = t.some(e => e.arrayish)
    const o = t.some(e => e.setish)
    return {
...
function M(e, t, n) {
  ...
  const i = r.appendChild(document.createElement('span'))
  return (
...
var Q = { prefix: 'async ƒ' }
var Z = { prefix: 'async ƒ*' }
var ee = { prefix: 'class' }
var te = { prefix: 'ƒ' }
var ne = { prefix: 'ƒ*' }
function re(e, t, n) {
...
const de = ce.map
const fe = ce.some
const pe = ce.hasOwnProperty
const he = 'https://cdn.jsdelivr.net/npm/'
const me = /^((?:@[^/@]+\/)?[^/@]+)(?:@([^/]+))?(?:\/(.*))?$/
const ve = /^\d+\.\d+\.\d+(-[\w-.+]+)?$/
const be = /\.[^/]*$/
const _e = ['unpkg', 'jsdelivr', 'browser', 'main']
...
var ge = Ee(async function (e, t) {
  ...
  if (/^[.]{0,2}\//i.test(e)) return new URL(e, t == null ? location : t).href
  if (!e.length || /^[\s._]/.test(e) || /\s$/.test(e)) { throw new RequireError('illegal name') }
  const n = we(e)
  if (!n) return `${he}${e}`
  if (!n.version && t != null && t.startsWith(he)) {
  ...
  download: function (e, t = 'untitled', n = 'Save') {
    ...
    return (
      ...
      (r.onclick = async t => {
        ...
        try {
          const t = await (typeof e === 'function' ? e() : e);
...
function Ue(e, t) {
  let n = !1
  if (typeof t !== 'function') throw new Error('dispose is not a function')
  return {
    [Symbol.iterator]: $e,
  ...
  define: {
    value: function (e, t, n) {
      ...
      return bt.call(
        this,
        e == null ? null : e + '',
        t == null ? [] : at.call(t, this._module._resolve, this._module),
        typeof n === 'function' ? n : lt(n)
      )
    },
    writable: !0,
    configurable: !0
